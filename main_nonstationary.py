...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("COMPARISON WITH STATIONARY PROCESS")
    print("="*80)
    print("\nKey Insights:")
    print("1. Non-stationary model captures realistic time-varying arrival patterns")
    print("2. Peak hours (11AM-12PM, 5PM-6PM) show much higher arrival rates")
    print("3. Maximum queue lengths provide insight into worst-case scenarios")
    print("4. Staffing needs may vary by time of day (not modeled here)")
    print("\nRecommendations for non-stationary model:")
    print("- Consider shift scheduling to match peak demand periods")
    print("- Monitor maximum queue lengths during peak hours")
    print("- May need additional staff during 11AM-1PM and 5PM-7PM periods")
